        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-[#6B7280] mb-4">
              Juju was created to solve a critical problem: job seekers struggle to stand out in competitive markets and often don't know how to optimize their applications for success.
            </p>
            <p className="text-lg text-[#6B7280] mb-4">
      ...
      <section className="bg-[#3B82F6] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of job seekers who have transformed their careers with Juju's AI-powered tools.
          </p>
          <Link
            href="/signup"
