      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-[#6B7280] mb-6">
            By accessing or using Juju's resume analysis and career coaching service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service, including businesses, developers, and end users.
          </p>
          ...
          <p className="text-[#6B7280] mb-6">
            The Service and all content, features, and functionality are owned by Juju and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-[#6B7280] mb-6">
            You agree to indemnify, defend, and hold harmless Juju and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 text-[#6B7280] mb-6 space-y-2">
          ...
          <p className="text-[#6B7280] mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and Juju regarding the Service and supersede all prior agreements.
          </p>
      ...
      <footer className="bg-[#2F3A40] text-white py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Juju. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
